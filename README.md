...
<br/>
![Fetch API](https://img.shields.io/badge/Fetch_API-FF6F00.svg?style=for-the-badge&logo=javascript&logoColor=white)
![PWA](https://img.shields.io/badge/PWA-5A0FC8.svg?style=for-the-badge&logo=pwa&logoColor=white)
![TWA](https://img.shields.io/badge/TWA-3DDC84.svg?style=for-the-badge&logo=android&logoColor=white)
...
* **[NYPC]** (2026.07)
    * 직무 : Algorithm Developer
    * 주요 활동: 
    * code : https://github.com/Qwmk-hub/nypc-next-nation
    * 요약설명 : 스타크래프트 처럼, 거점을 확보하고 병력을 증강하며 재화를 수급하고 상대기지와 본진을 공격해서 무너뜨리는 알고리즘을 구현함. 건설 -> 이동 -> 전쟁 -> 재화벌이 순으로 진행 되며, AI Agent를 활용해 현 상황을 파악하고, 최선의 방법을 연구하여 상대방을 공격하는 전략을 구현함
...
* **[최우수]**, [SW/ICT/AI 종합 학술대회] (2025.12)
    ...
    * 세션 : 수리데이터사이언스
    * 내용: MFCC 기반 코골이 탐지
    * code : https://github.com/Qwmk-hub/snoring_app
...
* **[우수]**, [WE-MEET 경진대회] (2025.12)
    * 주최: [지능형로봇사업단]
    * 내용: 운동데이터 기반 행동분류
    * code : https://github.com/Qwmk-hub/ml_project/tree/sungcheol
